...
#ifndef INC_20240306_INFEXPECTATION_COMPUTATION_TIMGRAPH_H
#define INC_20240306_INFEXPECTATION_COMPUTATION_TIMGRAPH_H

#endif //INC_20240306_INFEXPECTATION_COMPUTATION_TIMGRAPH_H
class TimGraph: public InfGraph
{
    public:
        TimGraph(string folder, string graph_file, string per):InfGraph(folder, graph_file, per){
        }
        double MgT(int u){
            //static int i=0;
            //i++;
